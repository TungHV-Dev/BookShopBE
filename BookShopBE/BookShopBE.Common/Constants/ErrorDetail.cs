namespace BookShopBE.Common.Constants
{
    public static class ErrorDetail
    {
        ...
        public const string NOT_FOUND = "Entity/element is not found";
        public const string ID_IS_NOT_EXIST = "Does not exist id ";
        public const string LIST_HAS_NO_ELEMENT = "List has no element";
        public const string USER_NAME_HAS_ALREADY_EXIST = "Username has already exist";
    }
}
